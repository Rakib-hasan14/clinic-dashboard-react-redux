...
export const fetchPateintPageData = (position,sort,fromDate,toDate,search) => async(dispatch) => {
    const response = await axios.get(`https://clinic-management-dashboard-backend-rakib-hasan14.vercel.app/clinic/pateints?status=${position}&fromDate=${fromDate}&toDate=${toDate}&searchKey=${search}`)
...
export const fetchSinglePateintPageData = (id) => async(dispatch) => {
    const response = await axios.get(`https://clinic-management-dashboard-backend-rakib-hasan14.vercel.app/clinic/pateints/single-details?id=${id}`)
...
export const AddPateintAction = (data) => async(dispatch) => {
    const response = await axios.post(`https://clinic-management-dashboard-backend-rakib-hasan14.vercel.app/clinic/pateints/add`,data)
...
export const deletePateintAction = (data) => async(dispatch) => {
    const response = await axios.post(`https://clinic-management-dashboard-backend-rakib-hasan14.vercel.app/clinic/pateints/delete`,data)
